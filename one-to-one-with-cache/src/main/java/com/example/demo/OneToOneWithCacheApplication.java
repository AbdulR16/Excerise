...
public class OneToOneWithCacheApplication {

	public static void main(String[] args) {
		SpringApplication.run(OneToOneWithCacheApplication.class, args);
	}
	...
	public CommandLineRunner runner() { // it is a bean it is called when the ioc container needs
		...
		return new CommandLineRunner() {
			...
			public void run(String... args) throws Exception {
				...
				Vendor vendor = new Vendor(1020,"Abd Travels","kknagar","transport");
				
				Company abc = new Company(4566,"abd corporation","software",vendor);
