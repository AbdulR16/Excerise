...
public class Invoice {
	...
	public String toString() {
		return "Invoice [invoiceNumber=" + invoiceNumber + ", customerName=" + customerName + ", quantity=" + quantity
				+ ", ratePerUnit=" + ratePerUnit + ", InvoiceDate=" + InvoiceDate + ", getInvoiceNumber()="
				+ getInvoiceNumber() + ", getCustomerName()=" + getCustomerName() + ", getQuantity()=" + getQuantity()
				+ ", getRatePerUnit()=" + getRatePerUnit() + ", getInvoiceDate()=" + getInvoiceDate() + ", hashCode()="
